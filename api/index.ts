        ...
        .prepare<[], SummaryRow>(
          `
            SELECT
              ...
              COUNT(DISTINCT CASE
                WHEN tt.live_status IN ('starting', 'working') THEN t.id
...
export function registerHandlers(
  ...
  return {
    ...
    listTaskThreadsForTasks(input) {
      return {
        taskThreads: store.tasks.listTaskThreadsForTasks(input.taskIds),
      };
    },
